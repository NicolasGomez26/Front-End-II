...
noticias.forEach(e => {
    ...
    <div class="tipoNoticia"}"> ${e.tipoNacional ? (container.innerHTML=`<img src="./img/arg.png">`):(container.innerHTML=`<img src="./img/globo.png" >`) }
    </div>
    <h2>${e.titulo}</h2>
...
// document.querySelector(".noticia").appendChild(nacional)
// document.querySelector(".noticia").appendChild(internacional)